<?php include_once('templates/header.php'); ?>
	...
	<div class="penises">
		...
		<div class="durr">
			<p>Information for producers and remixers.</p>
			<p class="fuckoff">If you're releasing stuff with us, you need to know this</p>
		</div>	
	</div>
...
<div class="bitches bitches_with_menu">
	...
	<div class="boring">
		...
		<ul>
			<li>Sell or try to profit from any of your material that isn't released via ALL CAPS.</li>
		</ul>
	...
	<h2 id="cc">Creative Commons</h2>
	
	<div class="boring">
	
		<p>We may, at any time, release or re-release anything our artists provide us with (tracks, samples, synths, art) under a Creative Commons License.</p>
		<p>For instance, we may release a single for purchase-only via Beatport, then a month later change our mind and give it away for free under a Creative Commons license.</p>
		<p>Usually, we'll use a <a href="http://creativecommons.org/licenses/by-nc-sa/2.0/" target="_blank">BY-NC-SA</a> license.</p>
	...
	<div class="boring">
		...
		<h4>If it's your release:</h4>
		<p>We take 30%, you take 70%. This is for the life of the release.</p>
		<p><img src="design/images/producers/30-70-split.jpg" alt="30-70-split"></p>

		<hr>
		
		<h4>If it's a collaboration with another artist:</h4>
		<p>We take 30%, then you and the other artist take half each, or 35%.</p>
		<p><img src="design/images/producers/30-35-35-split.jpg" alt="30-35-35-split"></p>
